...
read x0 x1 sizex <<< $(awk 'NR==6{print $1,$2,$2-$1}' $lammpsfile)
read y0 y1 sizey <<< $(awk 'NR==7{print $1,$2,$2-$1}' $lammpsfile)

echo $n_beads $x0 $x1 $y0 $y1
...
#elaborate with voro++
voro++ -c "%i %x %y %v %n" -o -px -py -g  $x0 $x1 $y0 $y1 0.00 0.01 tmp
